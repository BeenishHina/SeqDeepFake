...
from .attention_layer import (
    GaussianMultiheadAttention,
    DeformableRefinementAttention
)
...
class TransformerDecoderLayer(nn.Module):
    ...
    def __init__(self, dynamic_scale, smooth, layer_index,
        ...
        self.deform_attn = DeformableRefinementAttention(
          d_model=d_model,
          nhead=nhead,
          dropout=dropout
          )
    ...
    def forward_post(self, grid, h_w, tgt, memory,
        ...
        deform_out = self.deform_attn(
          tgt2,
          memory
          )
        tgt2 = tgt2 + 0.2 * deform_out
